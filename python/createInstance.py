...
if __name__ == "__main__":
    create_instance(fileName = "instance_train", limit=900, couriersPerWarehouse=5, pickersPerWarehouse=3, interArrivalTime=25, meanComissionTime=180, meanServiceTimeAtClient=60)